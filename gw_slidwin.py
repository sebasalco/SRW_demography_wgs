# Usage: 
# python ./gw_slidwin.py [vcf] [chrom_lengths] [window size] [step size] [chromosome/scaffold name]
#
...
# Create output file
output = open(filename + 'chr%s_het_%swin_%sstep.txt' % (chrom, window_size, step_size), 'w')
